...
describe(`Test of the Route class`, () => {
  ...
  it(`should not throw when Route() is called with valid handler.handle and match parameters`, () => {
    expect(() => new Route({handler, match})).not.to.throw();
  });

  it(`should not throw when Route() is called with a valid function handler and match parameters`, () => {
