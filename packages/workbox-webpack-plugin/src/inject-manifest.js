...
class InjectManifest {
   ...
   * @param {Array<Object>} [webpackCompilationPlugins] Optional `webpack`
   ...
   * @param {Array<string>} [chunks] One or more chunk names whose corresponding
   * output files should be included in the precache manifest.
   * @param {Array<string|RegExp|Function>} [exclude=[/\.map$/, /^manifest.*\.js$]]
   * One or more specifiers used to exclude assets from the precache manifest.
   * This is interpreted following
   * [the same rules](https://webpack.js.org/configuration/module/#condition)
   * as `webpack`'s standard `exclude` option.
   * @param {Array<string>} [excludeChunks] One or more chunk names whose
   * corresponding output files should be excluded from the precache manifest.
   * @param {Array<string|RegExp|Function>} [include]
