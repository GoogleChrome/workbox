...
describe(`Test Failing Cache Behavior`, () => {
  it('should fail to install revisioned with 404 cache request', () => {
  ...
  // it('should fail to install unrevisioned with 404 cache request', () => {
  ...
  it('should fail to cache revisioned opaque responses by default', () => {
    const revisionedCacheManager = new RevisionedCacheManager();
    revisionedCacheManager.addToCacheList({
  ...
  // it('should fail to cache unrevisioned opaque responses by default', () => {
  //   const unrevisionedCacheManager = new workbox.precaching.UnrevisionedCacheManager();
  //   unrevisionedCacheManager.addToCacheList({
