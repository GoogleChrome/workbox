...
describe(`Test of the broadcastUpdate function`, () => {
  ...
  it(`should throw when broadcastUpdate() is called without any parameters`, () => {
    expect(() => broadcastUpdate()).to.throw(TypeError);
  });

  it(`should trigger the appropriate message event on a BroadcastChannel with the same channel name`, (done) => {
