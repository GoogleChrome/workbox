...
Use [sw-cli](/packages/sw-cli/README.md) to add a service worker to an existing project in under two
minutes. 

## A build script in ten minutes

Generate a service worker in your build process
using [sw-build](/packages/sw-build/README.md).
...
[sw-lib](/packages/sw-lib/README.md) which lets
...
[recipes section](/docs/recipes), try the [examples](/docs/examples.md), or look up
something in the [modules reference](/docs/modules_overview.md).
