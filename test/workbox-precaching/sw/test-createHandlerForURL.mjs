...
describe(`createHandlerForURL()`, function() {
  ...
  it(`should return the expected handlerCallback for precached URLs`, async function() {
    ...
    // calls that return a hit. Third handlerCallback has a cache.match() call
    // that is a miss, which will lead to a call to fetch().
    ...
    const fetchStub = sandbox.stub(self, 'fetch').resolves(new Response('response 3'));
